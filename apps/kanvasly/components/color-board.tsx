          ...
          <div className="">
            ...
            <div className="">
              <div className="color-picker-container grid grid-cols-[1fr_1.5rem_2.5rem] md:grid-cols-[1fr_20px_1.625rem] max-w-[17rem] md:max-w-80 py-1 px-0 items-center">
                ...
                />
                <ColorPopover
                  selectedColor={strokeFill}
                  setColor={setStrokeFill}
                />
              </div>
            </div>
          </div>
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          className={cn(
            "color-picker__button active-color w-[1.625rem] h-[1.625rem] rounded-md border transition-all hover:scale-110 focus:outline-none focus:ring-2 focus:ring-ring ring-2 ring-ring ring-offset-2 ring-offset-background",
      ...
      <PopoverContent
        side="right"
        align="start"
        className="!left-5 absolute w-auto bg-background dark:bg-w-bg rounded-lg transition-transform duration-300 ease-in-out md:z-30 Island"
      >
        <PopoverArrow />
        <div className="w-[200px]">
          ...
          <div className="group grid grid-cols-[auto_1fr_auto_auto] gap-2 items-center border border-default-border-color focus-within:shadow-outline-primary-darkest dark:border-default-border-color-dark dark:focus-within:shadow-outline-primary-light-darker rounded-lg px-3 py-0 m-2">
            ...
            <Separator
              orientation="vertical"
              className="bg-default-border-color mx-auto py-1"
            />
...
function PopoverArrow() {
  return (
    <span className="popover-tooltip-arrow-pointer">
      <svg
        className="fill-white dark:fill-w-bg drop-shadow-md"
        width="20"
        height="10"
        viewBox="0 0 30 10"
