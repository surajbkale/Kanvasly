...
export function CollaborationAdDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
        ...
        >
          <DialogHeader className="gap-6">
            ...
            <div className="text-text-primary-color text-center text-[.875rem] leading-[150%] font-normal">
              ...
              Your work is securely stored, ensuring a seamless experience
              across devices. Sign up to create and join live sessions
              effortlessly.
            </div>
          </DialogHeader>
